...
#torch.nn.init.kaiming_uniform_(tensor, a=0, mode='fan_in', nonlinearity='leaky_relu', generator=None) He inizialization
...
BATCH_SIZE = 64 #128 for CartPole
GAMMA = 0.99
EPS_START = 0.9
EPS_END = 0.05
EPS_DECAY = 1000
...
import os 
path = os.path.join(os.getcwd(), 'Ex2/Results', 'Lunar.png')
...
policy_net.load_state_dict(torch.load('Ex2/Lunar_params.pth', weights_only=True),)
policy_net.eval()
